    ...
    def test_normalize_pegel_and_weather(self):
        ...
        sample_payload = {
            "pegel": {
                "number": "WORMS",
                "shortname": "WORMS",
                "currentMeasurement": {"value": 284, "stateMnwMhw": "normal"},
            },
            "weather": {
                "current": {
                    "temperature_2m": 18.5,
        ...
        self.assertEqual(gauges[0].status, "normal")
